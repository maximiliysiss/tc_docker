...
using System.Linq;
using TotalCommander.PodmanPlugin.Infrastructure.Extensions;
...
public sealed class PodmanExecutor : IPodmanExecutor
{
    private const StringSplitOptions Options = StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries;

    private readonly Console _console = new("podman");

    private readonly ILogger _logger = new TraceLogger("podmanplugin.log");
